...
class _Chat_Upload extends StringRequest {
    private static final String Site_URL_Login = "http://carnet-virtual.victoriacentre.ro/chat_upload_prof.php";
    private Map<String, String> params;

    _Chat_Upload(String Message, String CID, String TID, String TName, String CHType, String CHEDate, Response.Listener<String> listener) {
